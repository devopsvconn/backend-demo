            ...
            steps {
                script {
                    git credentialsId: 'github',
                        url: 'https://github.com/kanwarsaadali/BAZAR-BACKEND.git',
                        branch: 'main'
                }
            }
        }
...
//         // }
    ...
    steps {
        script {
            sh """
              cat backenddeploy.yml
              sed -i 's|image: ${IMAGE_NAME}.*|image: ${IMAGE_NAME}:${IMAGE_TAG}|' backenddeploy.yml
              cat backenddeploy.yml
            """
        }
    }
